---
description: >-
  The Insights page in your Mindee account lets you manage your subscription,
...
* Origin: origin of the request, either "Live Test" (platform) or API.
* Date Range: select start and end dates.
* Summary: summarize by day, month, or year.
* API Key: show all API keys or filter for a specific one.
* Options used: filter by [optional features](../models/optional-features/) activated in the call.\
  3 states to choose:
  * empty: no filter
