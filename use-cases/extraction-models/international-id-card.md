...
### Two Ways to Create Your International ID Model
...
* The International ID model template comes pre-configured with [standard fields](international-id-card.md#international-id-fields).
