...
* [**Invoices**](invoice.md) — Extract key data like supplier, amounts, due dates, and line items.
* [**Receipts**](receipt.md) — Capture totals, taxes, and line items for expense automation.
...
* [**Bill of Lading**](bill-of-lading.md) — Extract key data like shipper, consignee, and items shipped.
