---
description: Utility models are the Swiss Army Knives of document processing.
...
To see available integrations, check the model's "Documentation" page on the Mindee Platform.
{% endhint %}

## Create a Utility Model <a href="#creating-from-scratch" id="creating-from-scratch"></a>
